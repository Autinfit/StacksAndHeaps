...
int* funcion3()
{
    // IMPRIMIREMOS MENSAJES DE ENTEROS BÁSICOS INGRESADOS AUTOMÁTICAMENTE POR CONSOLA...

    // cout << a[0] << endl; // LEYENDO VALOR DE LA VARIABLE "a".
    // cout << b[0] << endl; // LEYENDO VALOR DE LA VARIABLE "b".

    // A CONTINUACIÓN, CREAREMOS OTRO PROCEDIMIENTO EN ESTA FUNCIÓN PARA ORIENTAR DE MEJOR FORMA LOS PUNTEROS CON VARIABLES...

    int a[10]; // ESTE ES UN STACK, YA QUE PUEDE ALMACENAR SOLAMENTE CON UN MÁXIMO DE HASTA 10 DATOS.
    int* b = new int[100000000]; // CON ESTA VARIABLE PUEDE ALMACENAR CIERTA CANTIDAD MÁXIMA DE HASTA 100000000 DATOS YA QUE ES UN "HEAP".
    a[0] = 13; // SE INGRESA UN VALOR CONSTANTE NÚMERO 1...
    b[0] = 15; // SE INGRESA UN VALOR CONSTANTE NÚMERO 2...

    return a; // RETORNA EL VALOR DE LA VARIABLE "a".
    // return b; // RETORNA EL VALOR DE LA VARIABLE "b".
}
...
int main()
{
    ...
    /*
    int a = 12345678; // VARIABLE PRINCIPAL DE PRUEBA.
    ...
    a_dir++; // AÑADE UN CONTADOR A LA VARIABLE QUE APUNTA A LA DIRECCIÓN DE MEMORIA.
    */
    ...
    */
    ...
    // DE AHÍ LLAMAREMOS A UNA FUNCIÓN MEDIANTE UN PUNTERO EN DONDE GUARDA EL VALOR AHÍ...
