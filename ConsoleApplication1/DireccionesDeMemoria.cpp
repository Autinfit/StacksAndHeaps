...
int* funcion3()
{
    ...
    int a[10]; // CREAREMOS UN ARREGLO DE LA VARIABLE "a" CON 10 NÚMEROS ENTEROS.
    int* b = new int[10]; // LOS 10 NÚMEROS ENTEROS SE GUARDAN MEDIANTE PUNTERO DE UNA NUEVA VARIABLE "b".
