...
- **_La asignación y desasignación de un Stack se realizan mediante instrucciones del compilador, mientras que la asignación y desasignación de un Heap las realiza el programador._**
