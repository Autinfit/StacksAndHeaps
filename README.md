...
As this data structure does not follow any methodology, it is a bit complicated to maintain control of the reserved memory blocks since spaces can be occupied and freed at any time.
